...
if __name__ == "__main__":
    ...
    p.add_argument(
        "--lex", "-l", action="store_true", default=False, help="Lex input (stdin)"
    )
    p.add_argument("--nl", action="store_true", default=False, help="Output NL tokens")
    p.add_argument(
        "--space", action="store_true", default=False, help="Output Whitespace tokens"
    )
