...
import base64, binascii, calendar, random, socket, struct, time
...
CLASS = Bimap(
    "CLASS", {1: "IN", 2: "CS", 3: "CH", 4: "Hesiod", 254: "None", 255: "*"}, DNSError
)
...
class DNSKEY(RD):
    ...
    def parse(cls, buffer, length):
        try:
            ...
            raise DNSError(
                "Error unpacking DNSKEY [offset=%d]: %s" % (buffer.offset, e)
            )
